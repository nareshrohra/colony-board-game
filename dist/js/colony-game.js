...
Config.FadeOutDuration = Config.FadeInDuration * .75; /*elements should be hidden faster to create room for new elements*/;//controller class for Game
